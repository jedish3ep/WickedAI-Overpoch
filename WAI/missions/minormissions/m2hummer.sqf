private ["_fileName", "_missionType", "_position", "_vehclass", "_vehname", "_picture", "_missionName", "_difficulty", "_missionDesc", "_winMessage", "_failMessage", "_tent", "_tent2", "_scenery", "_veh", "_skinArray", "_missiontimeout", "_cleanmission", "_playerPresent", "_starttime", "_currenttime", "_box", "_box1"];
...
/* Troops */
_skinArray = ["USMC_Soldier_LAT","USMC_Soldier_SL","USMC_SoldierM_Marksman"];
for "_i" from 1 to 3 do
	{
		private ["_rndnum","_skin"];
		_rndnum = round (random 3) + 4;
		_skin = _skinArray call BIS_fnc_selectRandom; 
		[_position,_rndnum,_difficulty,"Random",3,"",_skin,"Random","minor","WAIminorArray"] call spawn_group;
		sleep 0.1;
	};
...
if (_playerPresent) then 
	{
		...
		_box = createVehicle ["LocalBasicWeaponsBox",[(_position select 0) - 5,(_position select 1),0], [], 0, "CAN_COLLIDE"];
		_box1 = createVehicle ["LocalBasicWeaponsBox",[(_position select 0) + 5,(_position select 1),0], [], 0, "CAN_COLLIDE"];
