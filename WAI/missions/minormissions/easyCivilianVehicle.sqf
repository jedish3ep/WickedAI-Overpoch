...
_veharray = ["AH6X_DZ","GAZ_Vodnik_MedEvac","HMMWV_Ambulance","LandRover_CZ_EP1","MH6J_DZ","UAZ_INS"];
...
[_position,_rndnum,_difficulty,"Random",3,"","","Random","minor","WAIminorArray"] call spawn_group;
