...
private ["_fileName", "_missionType", "_position", "_veharray", "_vehclass", "_vehname", "_worldName", "_missionName", "_difficulty", "_missionDesc", "_winMessage", "_failMessage", "_picture", "_veh", "_rndnum", "_missiontimeout", "_cleanmission", "_playerPresent", "_starttime", "_currenttime", "_box", "_box1"];
