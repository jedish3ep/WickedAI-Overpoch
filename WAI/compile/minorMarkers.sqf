private ["_markerName", "_difficulty", "_markerColor", "_size", "_Minor1", "_Minor2"];

WAIMinorPos 	= _this select 0;
...
while {minor_missionrunning} do {
	...
	_Minor1 		= createMarker ["MinorMission", WAIMinorPos];
	...
	_Minor2 		= createMarker ["Minordot", WAIMinorPos];
